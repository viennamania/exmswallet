...
export async function getUsdtPrice(data: any) {
  ...
  const collection = client.db('exms').collection('setup');
...
export async function insertSellOrder(data: any) {
  ...
  const userCollection = client.db('exms').collection('users');
  ...
  const collection = client.db('exms').collection('orders');
...
export async function updateOne(data: any) {
  const client = await clientPromise;
  const collection = client.db('exms').collection('users');
...
export async function insertBuyOrder(data: any) {
  ...
  */
  ...
  const collection = client.db('exms').collection('buyorders');
