                ...
                <div className="flex flex-col items-start justify-center space-y-4">
                    ...
                    <div className='w-full flex flex-col items-start gap-5 mt-10'>
                        ...
                        <div className='w-full grid grid-cols-2 xl:grid-cols-5 gap-2 items-start justify-start'>
                            ...
                            {/*
                            orry    https://t.me/exms_orry_bot
                            koko    https://t.me/exms_koko_bot
                            bigrich    https://t.me/exms_bigrich_bot
                            ...
                            */}
                            ...
                            '>
                                <button
                                    onClick={() => {
                                        window.open('https://t.me/exms_orry_bot');
                                    }}
                                ...
                                <button
                                    onClick={() => {
                                        navigator.clipboard.writeText('https://t.me/exms_orry_bot');
                            ...
                            '>
                                <button
                                    onClick={() => {
                                        window.open('https://t.me/exms_koko_bot');
                                    }}
                                    className="w-full flex bg-blue-500 text-white p-2 rounded-lg"
                                >
                                    <div className='flex flex-row items-center gap-2'>
                                ...
                                <button
                                    onClick={() => {
                                        navigator.clipboard.writeText('https://t.me/exms_koko_bot');
                                        toast.success("텔레그램 링크가 복사되었습니다.");
                                    }}
                                    className="w-full flex bg-blue-500 text-white p-2 rounded-lg text-center"
                                >
                            ...
                            '>
                                <button
                                    onClick={() => {
                                        window.open('https://t.me/exms_bigrich_bot');
                                    }}
                                    className="w-full flex bg-blue-500 text-white p-2 rounded-lg"
                                >
                                    <div className='flex flex-row items-center gap-2'>
                                ...
                                <button
                                    onClick={() => {
                                        navigator.clipboard.writeText('https://t.me/exms_bigrich_bot');
                                        toast.success("텔레그램 링크가 복사되었습니다.");
                                    }}
                                    className="w-full flex bg-blue-500 text-white p-2 rounded-lg text-center"
                                >
                                                                        ...
                                                                        <button
                                                                            onClick={() => {
                                                                                navigator.clipboard.writeText(
                                                                                    'https://exms.me/kr/polygon/tbot/?center=' + selectedCenter + '&agent=' +
